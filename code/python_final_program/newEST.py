...
@ey                         
def new_customer(): #trying to keep all vars out of the global scope
    ...
    for NameError in name:
        try:
            ...
            if checker_value > -10:  # - 10 to inifinity and the input will give a failure
            ...
            while True:  # validator will trigger the program that way excution happens safely
                ...
                for _ in inside_regular_cleanr:
                    print(_.center(50),end="\n")
                    sleep(1.5)
            
                    print("--->Inside Delux Clearning..".center(50))
            
                for _ in inside_delux_clearning: # Using _ as a throw away only to print the selections (indoor regular and delux, and outdoor services)
                    print(_.cecnter(50),end="\n")
            ...
            return( name, auditor, outdoor_services,indoor_regular_services, indoor_delux)
