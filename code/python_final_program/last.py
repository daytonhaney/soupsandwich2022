...
def new_customer(name): #trying to keep all vars out of the global scope
    ...
    print("[Indoor Regular Cleaning]".center(50))
    ...
    print("[Indoor Delux Clearning]".center(50))
    ...
    selector ={"1": indoor_regular_services,
        "2"  : indoor_delux,                     
        3    : outdoor_services, }
    
    return name, auditor,outdoor_services, selector 
...
def main():
    ...
    selector 
    name, auditor, outdoor_services,indoor_regular_services, indoor_delux, = new_customer("name",selector)
